export const content = {
    ...
    list: [
      {
        ...
        objectives: [
          ...
          "Mettre en place des repères de pilotage",
        ...
        benefits: [
          ...
          "Pilotage efficace de l'activité",
        ],
      },
      {
        id: "structurer",
        ...
        objectives: [
          ...
          "Mettre en place des cadres de travail",
      ...
      },
      {
        ...
        deliverables: [
          "Rapport d'analyse organisationnelle",
      ...
      },
      {
        ...
        objectives: [
          ...
          "Garantir la conformité (ISO 9001, APSAD)",
          "Développer l'autonomie opérationnelle",
        ],
        deliverables: [
  ...
  copil: {
    ...
    missions: [
      {
        ...
        description:
          "Analyse des impacts terrain, financiers et qualité avant validation des décisions stratégiques.",
      },
      {
        title: "Anticipation des risques",
        description:
          "Identification et évaluation des risques opérationnels, qualité et conformité pour prévenir les difficultés.",
      },
      {
        title: "Traduction stratégie → terrain",
        description:
          "Déclinaison opérationnelle des orientations stratégiques avec les directeurs et équipes.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Suivi et veille ISO 9001 & APSAD pour garantir la conformité et l'amélioration continue.",
      },
      {
        title: "Vision globale transverse",
        description:
          "Articulation commerce/exploitation/finance/qualité pour une cohérence stratégique et opérationnelle.",
      },
    ],
    benefits: [
    ...
    modalities: {
      pricing: "3 000 € HT / mois",
      billing: "Facturation mensuelle",
      commitment: "Engagement mensuel renouvelable",
